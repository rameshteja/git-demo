...
<html lang="en">
  ...
  <body>
    <div class="container">
    <h1 class="text-center mt-5 mb-5">Password Change Page</h1>
        <div class="row mt-10">
        <div class="offset-4"></div>
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        <p class="card-text text-center">Reset Your password</p>
                        <form action="dashboard.php" method="post" onsubmit="return validate_resetPassword();">
                            ...
                            <div class="form-group">
                                ...
                                <small id="cPasswordError" class="form-text text-danger"></small>
                            </div>
